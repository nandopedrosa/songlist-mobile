class LocalizationStrings {
  static const localizedStrings = <String, List<String>>{
    ...
    "about_txt": [
      "Songlist Plus is a mobile app for managing songs, setlists, lyrics, chords and all the information your band needs to share in an easy and intuitive way.\n\nNo more printing tons of sheets of paper and carrying awkward binders to your gigs. Just add all your songs to Songlist Plus and you can easily find them and view lyrics or chords on your device.",
      "Songlist Plus é um aplicativo mobile para gerenciar músicas, repertórios, letras, cifras e todas as informações que sua banda precisa compartilhar de uma maneira fácil e intuitiva.\n\nNão imprima mais toneladas de papel nem carregue “pastinhas” para seus shows. Apenas adicione todas as suas músicas ao Songlist Plus e você poderá facilmente achá-las visualizar letras e cifras em qualquer dispositivo."
    ],
